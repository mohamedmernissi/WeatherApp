...
gpg --quiet --batch --yes --decrypt --passphrase="$IOS_KEYS" --output secrets/WeatherApp_Distribution.mobileprovision secrets/WeatherApp_Distribution.mobileprovision.gpg
